...
bench( pkg+'::1d,base', function benchmark( b ) {
	...
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimension( values[ i%values.length ], 0, s );
		if ( typeof v !== 'object' ) {
...
bench( pkg+'::1d,base,out-of-bounds', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimension( values[ i%values.length ], 0, s, opts );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( pkg+'::2d,base', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimension( values[ i%values.length ], 1, s );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( pkg+'::2d,base,out-of-bounds', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimension( values[ i%values.length ], 1, s, opts );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
