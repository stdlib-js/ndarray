...
tape( 'the function returns a NaN-filled array (dtype=float16, inferred)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns a NaN-filled array (dtype=float16, options)', function test( t ) {
	var expected;
	var arr;
	var x;
