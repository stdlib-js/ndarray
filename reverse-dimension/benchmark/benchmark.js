...
bench( format( '%s::2d,dim=0', pkg ), function benchmark( b ) {
	var values;
	var v;
	var i;
...
bench( format( '%s::2d,dim=1', pkg ), function benchmark( b ) {
	var values;
	var v;
	var i;
...
bench( format( '%s::3d,dim=0', pkg ), function benchmark( b ) {
	var values;
	var v;
	var i;
...
bench( format( '%s::3d,dim=1', pkg ), function benchmark( b ) {
	var values;
	var v;
	var i;
...
bench( format( '%s::3d,dim=2', pkg ), function benchmark( b ) {
	var values;
	var v;
	var i;
