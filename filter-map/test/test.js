...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof filterMap, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function filters and maps an array according to a callback function (row-major)', function test( t ) {
	var expected;
	var ord;
	var buf;
	var sh;
...
tape( 'the function filters and maps an array according to a callback function (column-major, contiguous)', function test( t ) {
	var expected;
	var ord;
	var buf;
	var sh;
...
tape( 'the function filters and maps an array according to a callback function (row-major, contiguous, options)', function test( t ) {
	var expected;
	var opts;
	var ord;
	var buf;
...
tape( 'the function filters and maps an array according to a callback function (column-major, contiguous, options)', function test( t ) {
	var expected;
	var opts;
	var ord;
	var buf;
