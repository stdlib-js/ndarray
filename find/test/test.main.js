...
tape( 'the function returns a new ndarray containing the first elements which pass a test implemented by a predicate function along one or more ndarray dimensions (row-major)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function returns a new ndarray containing the first elements which pass a test implemented by a predicate function along one or more ndarray dimensions (column-major)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function supports providing an execution context (options)', function test( t ) {
	...
	values = [];
	arrays = [];
	actual = find( x, opts, predicate, ctx );
	expected = [ 2.0, 4.0 ];
