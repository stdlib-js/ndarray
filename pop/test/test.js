...
tape( 'the function returns an array containing read-only ndarrays (ndims=1)', function test( t ) {
	var actual;
	var buf;
	var ord;
	var sh;
...
tape( 'the function returns an array containing read-only ndarrays (ndims=1, options)', function test( t ) {
	var actual;
	var opts;
	var buf;
	var ord;
...
tape( 'the function returns an array containing read-only ndarrays (ndims=2)', function test( t ) {
	var actual;
	var buf;
	var ord;
	var sh;
...
tape( 'the function returns an array containing read-only ndarrays (ndims=2, options)', function test( t ) {
	var actual;
	var opts;
	var buf;
	var ord;
...
tape( 'the function returns an array containing read-only ndarrays (ndims=3)', function test( t ) {
	var actual;
	var buf;
	var ord;
	var sh;
...
tape( 'the function returns an array containing read-only ndarrays (ndims=3, options)', function test( t ) {
	var actual;
	var opts;
	var buf;
	var ord;
...
tape( 'the function returns empty read-only views if provided an empty array (ndims=2)', function test( t ) {
	var actual;
	var buf;
	var ord;
	var sh;
...
tape( 'the function returns empty read-only views if provided an empty array (ndims=2, options)', function test( t ) {
	var actual;
	var opts;
	var buf;
	var ord;
