...
tape( 'the function tests whether all elements along one or more ndarray dimensions pass a test implemented by a predicate function (row-major)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function tests whether all elements along one or more ndarray dimensions pass a test implemented by a predicate function (column-major)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function supports providing an execution context', function test( t ) {
	...
	values = [];
	arrays = [];
	actual = everyBy( x, predicate, ctx );
	expected = true;
...
tape( 'the function supports providing an execution context (options)', function test( t ) {
	...
	values = [];
	arrays = [];
	actual = everyBy( x, opts, predicate, ctx );
	expected = [ true, true ];
