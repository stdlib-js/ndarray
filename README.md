...
```javascript
import { array, base, dispatch, ind2sub, ndarray, ndarray2array, ndarrayCastingModes, ndarrayDataTypes, ndarrayIndexModes, ndarrayMinDataType, ndarrayNextDataType, ndarrayOrders, ndarrayPromotionRules, ndarraySafeCasts, ndarraySameKindCasts, ndempty, ndzeros, ndzerosLike, scalar2ndarray, sub2ind } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray@deno/mod.js';
```
