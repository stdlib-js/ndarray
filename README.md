...
```javascript
import { FancyArray, array, base, defaults, dispatch, ind2sub, ndarray, ndarray2array, ndarrayCastingModes, ndarrayDataTypes, ndarrayIndexModes, ndarrayMinDataType, ndarrayNextDataType, ndarrayOrders, ndarrayOutputDataTypePolicies, ndarrayPromotionRules, ndarraySafeCasts, ndarraySameKindCasts, ndempty, ndemptyLike, ndslice, ndzeros, ndzerosLike, scalar2ndarray, sub2ind } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray@deno/mod.js';
```
