...
> Return a kernel for applying a one-dimensional strided array function to two input ndarrays and assigning results to an output ndarray.
...
```javascript
var kernel = require( '@stdlib/ndarray/base/kernels/generic/binary-strided1d/unblocked' );
```

#### kernel( ndims )

Returns a kernel for applying a one-dimensional strided array function to two input ndarrays and assigning results to an output ndarray.
...
#### kernel.kernel0d( fcn, arrays, views, shape, stridesX, strideY, strideZ, strategyX, strategyY, strategyZ, options )
...
// Apply strided function:
kernel.kernel0d( gwxpy, [ x, y, z ], [], [], [], [], [], strategy, strategy, strategy, {} );
...
#### kernel.kernel1d( fcn, arrays, views, shape, stridesX, strideY, strideZ, strategyX, strategyY, strategyZ, options )
...
// Apply strided function:
kernel.kernel1d( gwxpy, [ x, y, z ], views, [ 3 ], [ 4 ], [ 4 ], [ 4 ], strategy, strategy, strategy, {} );
