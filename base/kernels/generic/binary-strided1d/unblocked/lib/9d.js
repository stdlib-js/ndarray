...
var incrementOffsets = require( './../../../../../../base/kernels/utils/increment-offsets' );
var setViewOffsets = require( './../../../../../../base/set-descriptor-offsets' );
var offsets = require( './../../../../../../base/offsets' );
...
* kernel( gwxpy, [ x, y, z ], views, [ 1, 1, 1, 1, 1, 1, 1, 1, 3 ], [ 12, 12, 12, 12, 12, 12, 12, 12, 4 ], [ 12, 12, 12, 12, 12, 12, 12, 12, 4 ], [ 12, 12, 12, 12, 12, 12, 12, 12, 4 ], strategy, strategy, strategy, {} );
*
...
*/
function kernel( fcn, arrays, views, shape, stridesX, stridesY, stridesZ, strategyX, strategyY, strategyZ, opts ) { // eslint-disable-line max-params, max-statements
	var dv0;
	var dv1;
	var dv2;
	var dv3;
