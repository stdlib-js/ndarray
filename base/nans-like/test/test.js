...
tape( 'the function returns a NaN-filled array (dtype=float16, base)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns a NaN-filled array (dtype=float16, non-base)', function test( t ) {
	var expected;
	var arr;
	var x;
