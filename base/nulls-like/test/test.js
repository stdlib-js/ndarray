...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof nullsLike, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns a null-filled array (dtype=generic, base)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns a null-filled array (dtype=generic, non-base)', function test( t ) {
	var expected;
	var arr;
	var x;
