...
// The function returns an ndarray...
{
	...
	sliceDimensionTo( empty( 'float16', sh, order ), 1, s, false, false ); // $ExpectType float16ndarray
	...
	sliceDimensionTo( empty( 'float16', sh, order ), 1, s, true, true ); // $ExpectType float16ndarray
