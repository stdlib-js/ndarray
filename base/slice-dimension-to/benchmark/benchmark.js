...
bench( pkg+'::1d,base', function benchmark( b ) {
	...
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimensionTo( values[ i%values.length ], 0, s, false, false );
		if ( typeof v !== 'object' ) {
...
bench( pkg+'::2d,base', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimensionTo( values[ i%values.length ], 1, s, false, false );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( pkg+'::3d,base', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimensionTo( values[ i%values.length ], 2, s, false, false );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( pkg+'::4d,base', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimensionTo( values[ i%values.length ], 3, s, false, false );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( pkg+'::5d,base', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = sliceDimensionTo( values[ i%values.length ], 4, s, false, false );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
