...
tape( 'the function returns a filled array (dtype=float16, order=row-major)', function test( t ) {
	var expected;
	var arr;
	...
	arr = fullBy( 'float16', [ 2, 2 ], 'row-major', clbk );
	t.strictEqual( instanceOf( arr, ndarray ), true, 'returns expected value' );
...
tape( 'the function returns a filled array (dtype=float16, order=column-major)', function test( t ) {
	var expected;
	var arr;
	...
	arr = fullBy( 'float16', [ 2, 2 ], 'column-major', clbk );
	t.strictEqual( instanceOf( arr, ndarray ), true, 'returns expected value' );
	t.strictEqual( String( getDType( arr ) ), 'float16', 'returns expected value' );
	t.deepEqual( getShape( arr ), [ 2, 2 ], 'returns expected value' );
	t.strictEqual( instanceOf( getData( arr ), Float16Array ), true, 'returns expected value' );
