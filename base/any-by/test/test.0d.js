...
tape( 'the function tests whether at least one element in a 0-dimensional ndarray passes a test implemented by a predicate function', function test( t ) {
	var actual;
	var x;
...
tape( 'the function tests whether at least one element in a 0-dimensional ndarray passes a test implemented by a predicate function (accessors)', function test( t ) {
	var actual;
	var x;
