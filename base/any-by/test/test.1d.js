...
tape( 'the function tests whether at least one element in a 1-dimensional ndarray passes a test implemented by a predicate function', function test( t ) {
	var actual;
	var x;
...
tape( 'the function tests whether at least one element in a 1-dimensional ndarray passes a test implemented by a predicate function (accessors)', function test( t ) {
	var actual;
	var xbuf;
	var x;
...
tape( 'the function supports specifying the callback execution context', function test( t ) {
	...
	x = new ndarray( 'float64', zeros( 8, 'float64'), [ 4 ], [ 2 ], 0, 'row-major' );
