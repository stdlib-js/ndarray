...
tape( 'the function returns an ndarray filled with `true` values and (dtype=generic, base)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values and (dtype=generic, non-base)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values and (dtype=bool, base)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values and (dtype=bool, non-base)', function test( t ) {
	var expected;
	var arr;
	var x;
