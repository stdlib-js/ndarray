...
tape( 'the function counts the number of elements in a 1-dimensional ndarray which pass a test implemented by a predicate function', function test( t ) {
	var actual;
	var x;
...
tape( 'the function counts the number of elements in a 1-dimensional ndarray which pass a test implemented by a predicate function (accessors)', function test( t ) {
	var actual;
	var xbuf;
	var x;
