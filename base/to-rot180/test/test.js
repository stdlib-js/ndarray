...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees in a specified plane (dtype=float64, base, row-major)', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees in a specified plane (dtype=float64, base, column-major)', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees in a specified plane (dtype=float64, non-base)', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees in a specified plane (dtype=float32)', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees (dtype=complex128, base)', function test( t ) {
	var arr;
	var buf;
	var v;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees (dtype=complex64, base)', function test( t ) {
	var arr;
	var buf;
	var v;
	var x;
...
tape( 'the function returns a new ndarray where a matrix is rotated 180 degrees in a specified plane (dtype=generic)', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
...
tape( 'the function supports negative dimension indices', function test( t ) {
	...
	// dims=[-1,-2] should also produce 180-degree rotation (symmetric):
	arr = toRot180( x, [ -1, -2 ] );
	expected = [ [ 6.0, 5.0, 4.0 ], [ 3.0, 2.0, 1.0 ] ];
	t.deepEqual( ndarray2array( arr ), expected, 'returns expected value' );
...
tape( 'the function supports rotation in arbitrary planes for higher-dimensional ndarrays', function test( t ) {
	...
	// dims=[0,1] (rotation in plane spanned by stack and row axes):
	arr = toRot180( x, [ 0, 1 ] );
	t.deepEqual( getShape( arr ), [ 2, 2, 3 ], 'returns expected value' );
	expected = [
		[ [ 10, 11, 12 ], [ 7, 8, 9 ] ],
...
tape( 'the function returns the original arrangement when rotating twice in the same plane', function test( t ) {
	var expected;
	var arr;
	var buf;
	var x;
