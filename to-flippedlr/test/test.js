...
tape( 'the function returns a new ndarray where the order of elements along the last dimension is reversed (ndims=1)', function test( t ) {
	var expected;
	var actual;
	var buf;
	var ord;
...
tape( 'the function returns a new ndarray where the order of elements along the last dimension is reversed (ndims=2)', function test( t ) {
	var expected;
	var actual;
	var buf;
	var ord;
...
tape( 'the function returns a new ndarray where the order of elements along the last dimension is reversed (ndims=3)', function test( t ) {
	var expected;
	var actual;
	var buf;
	var ord;
