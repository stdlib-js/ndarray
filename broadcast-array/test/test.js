...
tape( 'the function returns a read-only ndarray', function test( t ) {
	var x;
	var y;

	x = array( [ [ 1, 2 ], [ 3, 4 ] ] );
	y = broadcastArray( x, [ 2, 2, 2 ] );
