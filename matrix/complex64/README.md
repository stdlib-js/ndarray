...
> Create a single-precision complex floating-point matrix (i.e., a two-dimensional [ndarray][@stdlib/ndarray/ctor]).
...
Creates a two-dimensional single-precision complex floating-point [ndarray][@stdlib/ndarray/ctor] from an array-like object or iterable.
