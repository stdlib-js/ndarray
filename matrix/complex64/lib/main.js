...
/**
* Returns a single-precision complex floating-point matrix (i.e., a two-dimensional ndarray).
*
...
* // returns [ 2, 1 ]
*/
var Complex64Matrix = factory( 'complex64' );


// EXPORTS //

module.exports = Complex64Matrix;
