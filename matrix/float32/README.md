...
> Create a single-precision floating-point matrix (i.e., a two-dimensional [ndarray][@stdlib/ndarray/ctor]).
...
#### Float32Matrix( \[options] )

Returns a two-dimensional single-precision floating-point [ndarray][@stdlib/ndarray/ctor].
...
#### Float32Matrix( shape\[, options] )

Returns a two-dimensional single-precision floating-point [ndarray][@stdlib/ndarray/ctor] having a specified shape.
...
#### Float32Matrix( obj\[, options] )

Creates a two-dimensional single-precision floating-point [ndarray][@stdlib/ndarray/ctor] from an array-like object or iterable.
...
Returns a two-dimensional single-precision floating-point [ndarray][@stdlib/ndarray/ctor] view of an [`ArrayBuffer`][@stdlib/array/buffer].
...
var arr1 = new Float32Matrix( buf );
// returns <ndarray>

var sh1 = getShape( arr1 );
// returns [ 1, 16 ]

var arr2 = new Float32Matrix( buf, 16 );
// returns <ndarray>

var sh2 = getShape( arr2 );
// returns [ 1, 12 ]

var arr3 = new Float32Matrix( buf, 16, [ 2, 1 ] );
// returns <ndarray>
...
#### Float32Matrix( buffer\[, byteOffset\[, M, N]]\[, options] )
...
var arr = new Float32Matrix( buf, 16, 2, 1 );
// returns <ndarray>
...
[@stdlib/ndarray/matrix/complex128]: https://github.com/stdlib-js/ndarray/tree/main/matrix/complex128
