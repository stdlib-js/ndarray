...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof truesLike, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function throws an error if provided an options argument which is not an object', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			truesLike( empty( 'generic', [ 2, 2 ], 'row-major' ), value );
		};
	}
});
...
tape( 'the function throws an error if provided a `dtype` option which is not a recognized data type', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			truesLike( empty( 'generic', [ 2, 2 ], 'row-major' ), {
				'dtype': value
			});
		};
	}
...
tape( 'the function returns an ndarray filled with `true` values (dtype=bool, inferred)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values (dtype=bool, options)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values (dtype=bool, options, integer shape)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values (dtype=generic, inferred)', function test( t ) {
	var expected;
	var arr;
	var x;
...
tape( 'the function returns an ndarray filled with `true` values (dtype=generic, options)', function test( t ) {
	var expected;
	var arr;
	var x;
