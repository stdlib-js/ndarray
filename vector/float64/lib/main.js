...
/**
* Returns a double-precision floating-point vector (i.e., a one-dimensional ndarray).
*
* @name Float64Vector
* @type {Function}
...
*
* var buf = new ArrayBuffer( 32 );
* var arr = new Float64Vector( buf, 16 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 2
...
* var arr = new Float64Vector( buf, 16, 2 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 2
*/
var Float64Vector = factory( 'float64' );
