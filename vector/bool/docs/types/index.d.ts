...
interface BooleanVector {
	...
	* // returns 2
	*/
	new ( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): boolndarray;
	...
	*
	* var buf = new ArrayBuffer( 32 );
	* var arr = new BooleanVector( buf, 8 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 24
	...
	* // returns 2
	*/
	( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): boolndarray;
