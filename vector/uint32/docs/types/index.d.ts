...
interface Uint32Vector {
	...
	* // returns 2
	*/
	new ( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): uint32ndarray;
	...
	*
	* var buf = new ArrayBuffer( 32 );
	* var arr = new Uint32Vector( buf, 8 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 6
	...
	* // returns 2
	*/
	( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): uint32ndarray;
