...
import { Order, Mode, complex64ndarray } from '@stdlib/types/ndarray';
...
interface Complex64Vector {
	...
	* // returns 2
	*/
	new ( length: number, options?: Options ): complex64ndarray;
	...
	* // returns 2
	*/
	new ( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): complex64ndarray;
	...
	*
	* var buf = new ArrayBuffer( 32);
	* var arr = new Complex64Vector( buf, 8 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 3
	...
	*
	* var buf = new ArrayBuffer( 32 );
	* var arr = new Complex64Vector( buf, 8, 2 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 2
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): complex64ndarray;
	...
	* // returns 2
	*/
	( length: number, options?: Options ): complex64ndarray;
	...
	* // returns 2
	*/
	( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): complex64ndarray;
	...
	* // returns 2
	*/
	( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): complex64ndarray;
}
...
* // returns 2
*/
declare var ctor: Complex64Vector;
