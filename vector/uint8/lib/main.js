...
/**
* Returns an unsigned 8-bit integer vector (i.e., a one-dimensional ndarray).
*
* @name Uint8Vector
* @type {Function}
...
*
* var buf = new ArrayBuffer( 32 );
* var arr = new Uint8Vector( buf, 16 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 16
...
* var arr = new Uint8Vector( buf, 16, 2 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 2
*/
var Uint8Vector = factory( 'uint8' );


// EXPORTS //

module.exports = Uint8Vector;
