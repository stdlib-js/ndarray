...
/**
* Returns a double-precision complex floating-point vector (i.e., a one-dimensional ndarray).
*
...
* var arr = new Complex128Vector( buf, 16 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 2
...
* // returns 2
*/
var Complex128Vector = factory( 'complex128' );


// EXPORTS //

module.exports = Complex128Vector;
